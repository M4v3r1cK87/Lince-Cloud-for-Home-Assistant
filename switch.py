...
class GoldCloud_SocketEntity(SwitchEntity, RestoreEntity):
...
class GoldCloud_NotificationsEntity(SwitchEntity, RestoreEntity):
    """Switch per abilitare/disabilitare le notifiche di sistema."""
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    for system in coordinator.data:
        ...
        model = f'{system.get("model", "Unknown")}'
        entities.append(GoldCloud_SocketEntity(row_id, centrale_name, model, api))

        # Switch per Notifiche (uno per centrale)
        entities.append(GoldCloud_NotificationsEntity(hass, row_id, centrale_name))
